...
def getCountryCode3(countryCode = "GB", language = "en"):
    countries = {
        'AF':'AFG',
        'AX':'ALA',
        'AL':'ALB',
...
def getCountries2():
    return ["AF", "AX", "AL", "DZ", "AS", "AD", "AO", "AI", "AQ", "AG", "AR", "AM", "AW", "AU", "AT", "AZ", "BS", "BH", "BD", "BB", "BY", "BE", "BZ", "BJ", "BM", "BT", "BO", "BQ", "BA", "BW", "BV", "BR", "IO","BN", "BG", "BF", "BI", "CV", "KH", "CM", "CA", "KY", "CF", "TD",
